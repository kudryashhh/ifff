...
document.addEventListener("DOMContentLoaded", function(){
    ...
    let ii = document.getElementById("back_to_menu_on"); 
    ...
    let shop_on = document.getElementById("shop_on"); 
    ...
    let space_on = document.getElementById("space_on"); 
    ...
    let manifesto_on = document.getElementById("manifesto_on"); 
   
    manifesto.addEventListener("mouseenter", function(){ 
    manifesto_on.style.display = "block"; 
    });

    manifesto.addEventListener("mouseleave", function(){ 
    manifesto_on.style.display = "none"; 
    });
    

    let ceremony = document.getElementById("ceremony");
    let ceremony_on = document.getElementById("ceremony_on"); 
    ...
    let events_on = document.getElementById("events_on"); 
